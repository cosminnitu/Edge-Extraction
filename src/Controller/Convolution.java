...
public class Convolution {
    ...
    public static double[][] convolution2DP(double[][] input,
                                                 int width, int height,
                                                 double[][] kernel,
                                                 int kernelWidth,
                                                 int kernelHeight) {
    ...
    //kernel ce reprezinta matricea filtru impreuna cu dimensiunile acesteia
    public double[][] convolutionType2(double[][] input,
        ...
        for (int i = 0; i < iterations; ++i) {
            output = convolution2DP(newInput, width, height,
                    kernel, kernelWidth, kernelHeight);
